...
var require_error = __commonJS({
  "node_modules/@shopify/shopify-api/lib/error.js"(exports) {
    ...
    var HttpThrottlingError = class extends HttpRetriableError {
      constructor(_a2) {
        var { retryAfter } = _a2, params = tslib_1.__rest(_a2, ["retryAfter"]);
        super(params);
...
var require_version = __commonJS({
  "node_modules/@shopify/shopify-api/lib/version.js"(exports) {
    ...
    exports.SHOPIFY_API_LIBRARY_VERSION = "9.6.0";
  }
});
...
var require_headers = __commonJS({
  "node_modules/@shopify/shopify-api/runtime/http/headers.js"(exports) {
    ...
    function getHeader(headers, needle) {
      ...
      if (!headers)
        return void 0;
      return (_a2 = getHeaders(headers, needle)) === null || _a2 === void 0 ? void 0 : _a2[0];
    }
  ...
  "node_modules/@shopify/shopify-api/runtime/http/cookies.js"(exports) {
    ...
    var Cookies = class _Cookies {
      ...
      constructor(request, response, { keys = [] } = {}) {
        ...
        if (keys)
          this.keys = keys;
        const cookieReqHdr = (_a2 = (0, headers_1.getHeader)(request.headers, "Cookie")) !== null && _a2 !== void 0 ? _a2 : "";
        this.receivedCookieJar = _Cookies.parseCookies(cookieReqHdr.split(";"));
        const cookieResHdr = (_b2 = (0, headers_1.getHeaders)(response.headers, "Set-Cookie")) !== null && _b2 !== void 0 ? _b2 : [];
      ...
      get(name) {
        var _a2;
        return (_a2 = this.receivedCookieJar[name]) === null || _a2 === void 0 ? void 0 : _a2.value;
      }
      deleteCookie(name) {
        this.set(name, "", {
          path: "/",
      ...
      get canSign() {
        var _a2;
        return ((_a2 = this.keys) === null || _a2 === void 0 ? void 0 : _a2.length) > 0;
      }
      set(name, value, opts = {}) {
...
var require_common = __commonJS({
  "node_modules/@shopify/shopify-api/lib/clients/common.js"(exports) {
    ...
    function throwFailedRequest(body, response, atMaxRetries) {
      var _a2, _b2, _c;
      const responseHeaders = (0, runtime_1.canonicalizeHeaders)(Object.fromEntries((_a2 = response.headers.entries()) !== null && _a2 !== void 0 ? _a2 : []));
      if (response.status === network_1.StatusCode.Ok && body.errors.graphQLErrors) {
        throw new ShopifyErrors.GraphqlQueryError({
          message: (_c = (_b2 = body.errors.graphQLErrors) === null || _b2 === void 0 ? void 0 : _b2[0].message) !== null && _c !== void 0 ? _c : "GraphQL operation failed",
          response,
    ...
    var GraphqlClient = class {
      constructor(params) {
        ...
        this.client = (0, admin_api_client_1.createAdminApiClient)({
          accessToken: (_a2 = config.adminApiAccessToken) !== null && _a2 !== void 0 ? _a2 : this.session.accessToken,
          apiVersion: (_b2 = this.apiVersion) !== null && _b2 !== void 0 ? _b2 : config.apiVersion,
...
// node_modules/@shopify/storefront-api-client/dist/umd/storefront-api-client.min.js
var require_storefront_api_client_min = __commonJS({
  "node_modules/@shopify/storefront-api-client/dist/umd/storefront-api-client.min.js"(exports, module) {
    !function(e, r) {
      "object" == typeof exports && "undefined" != typeof module ? r(exports) : "function" == typeof define && define.amd ? define(["exports"], r) : r((e = "undefined" != typeof globalThis ? globalThis : e || self).ShopifyStorefrontAPIClient = {});
    }(exports, function(e) {
      "use strict";
      const r = "GraphQL Client", t = 0, n = 3, o = "An error occurred while fetching from the API. Review 'graphQLErrors' for details.", s = "Response returned unexpected Content-Type:", i = "An unknown error has occurred. The API did not return a data object or any errors in its response.", a = { json: "application/json", multipart: "multipart/mixed" }, c = "X-SDK-Variant", u = "X-SDK-Version", l = "shopify-graphql-client", p = "0.10.3", d = 1e3, f = [429, 503], h = /@(defer)\b/i, y = /boundary="?([^=";]+)"?/i, m = "\r\n\r\n";
      function g(e2, t2 = r) {
        return e2.startsWith(`${t2}`) ? e2 : `${t2}: ${e2}`;
      }
      function w(e2) {
        return e2 instanceof Error ? e2.message : JSON.stringify(e2);
      }
      function b(e2) {
        return e2 instanceof Error && e2.cause ? e2.cause : void 0;
      }
      function $(e2) {
        return e2.flatMap(({ errors: e3 }) => e3 ?? []);
      }
      function A({ client: e2, retries: r2 }) {
        if (void 0 !== r2 && ("number" != typeof r2 || r2 < t || r2 > n))
          throw new Error(`${e2}: The provided "retries" value (${r2}) is invalid - it cannot be less than ${t} or greater than ${n}`);
      }
      function S(e2, r2) {
        return r2 && ("object" != typeof r2 || Array.isArray(r2) || "object" == typeof r2 && Object.keys(r2).length > 0) ? { [e2]: r2 } : {};
      }
      function v(e2, r2) {
        if (0 === e2.length)
          return r2;
        const t2 = { [e2.pop()]: r2 };
        return 0 === e2.length ? t2 : v(e2, t2);
      }
      function x(e2, r2) {
        return Object.keys(r2 || {}).reduce((t2, n2) => ("object" == typeof r2[n2] || Array.isArray(r2[n2])) && e2[n2] ? (t2[n2] = x(e2[n2], r2[n2]), t2) : (t2[n2] = r2[n2], t2), Array.isArray(e2) ? [...e2] : { ...e2 });
      }
      function E([e2, ...r2]) {
        return r2.reduce(x, { ...e2 });
      }
      function T({ clientLogger: e2, customFetchApi: t2 = fetch, client: n2 = r, defaultRetryWaitTime: o2 = d, retriableCodes: s2 = f }) {
        const i2 = async (r2, a2, c2) => {
          const u2 = a2 + 1, l2 = c2 + 1;
          let p2;
          try {
            if (p2 = await t2(...r2), e2({ type: "HTTP-Response", content: { requestParams: r2, response: p2 } }), !p2.ok && s2.includes(p2.status) && u2 <= l2)
              throw new Error();
            return p2;
          } catch (t3) {
            if (u2 <= l2) {
              const t4 = p2 == null ? void 0 : p2.headers.get("Retry-After");
              return await async function(e3) {
                return new Promise((r3) => setTimeout(r3, e3));
              }(t4 ? parseInt(t4, 10) : o2), e2({ type: "HTTP-Retry", content: { requestParams: r2, lastResponse: p2, retryAttempt: a2, maxRetries: c2 } }), i2(r2, u2, c2);
            }
            throw new Error(g(`${c2 > 0 ? `Attempted maximum number of ${c2} network retries. Last message - ` : ""}${w(t3)}`, n2));
          }
        };
        return i2;
      }
      function k({ headers: e2, url: t2, customFetchApi: n2 = x, retries: o2 = 0, logger: i2 }) {
        A({ client: r, retries: o2 });
        const f2 = { headers: e2, url: t2, retries: o2 }, v2 = function(e3) {
          return (r2) => {
            e3 && e3(r2);
          };
        }(i2), x2 = function(e3, { url: t3, headers: n3, retries: o3 }) {
          return async (s2, i3 = {}) => {
            const { variables: a2, headers: d2, url: f3, retries: h2 } = i3, y2 = JSON.stringify({ query: s2, variables: a2 });
            A({ client: r, retries: h2 });
            const m2 = Object.entries({ ...n3, ...d2 }).reduce((e4, [r2, t4]) => (e4[r2] = Array.isArray(t4) ? t4.join(", ") : t4.toString(), e4), {});
            m2[c] || m2[u] || (m2[c] = l, m2[u] = p);
            return e3([f3 ?? t3, { method: "POST", headers: m2, body: y2 }], 1, h2 ?? o3);
          };
        }(T({ customFetchApi: n2, clientLogger: v2, defaultRetryWaitTime: d }), f2), k2 = function(e3) {
          return async (...r2) => {
            if (h.test(r2[0]))
              throw new Error(g("This operation will result in a streamable response - use requestStream() instead."));
            try {
              const t3 = await e3(...r2), { status: n3, statusText: o3 } = t3, i3 = t3.headers.get("content-type") || "";
              return t3.ok ? i3.includes(a.json) ? j(t3) : { errors: { networkStatusCode: n3, message: g(`${s} ${i3}`), response: t3 } } : { errors: { networkStatusCode: n3, message: g(o3), response: t3 } };
            } catch (e4) {
              return { errors: { message: w(e4) } };
            }
          };
        }(x2), C2 = function(e3) {
          return async (...r2) => {
            if (!h.test(r2[0]))
              throw new Error(g("This operation does not result in a streamable response - use request() instead."));
            try {
              const t3 = await e3(...r2), { statusText: n3 } = t3;
              if (!t3.ok)
                throw new Error(n3, { cause: t3 });
              const o3 = t3.headers.get("content-type") || "";
              switch (true) {
                case o3.includes(a.json):
                  return function(e4) {
                    return { async *[Symbol.asyncIterator]() {
                      const r3 = await j(e4);
                      yield { ...r3, hasNext: false };
                    } };
                  }(t3);
                case o3.includes(a.multipart):
                  return function(e4, r3) {
                    var _a2;
                    const t4 = (r3 ?? "").match(y), n4 = `--${t4 ? t4[1] : "-"}`;
                    if (!((_a2 = e4.body) == null ? void 0 : _a2.getReader) && !e4.body[Symbol.asyncIterator])
                      throw new Error("API multipart response did not return an iterable body", { cause: e4 });
                    const o4 = async function* (e5) {
                      const r4 = new TextDecoder();
                      if (e5.body[Symbol.asyncIterator])
                        for await (const t5 of e5.body)
                          yield r4.decode(t5);
                      else {
                        const t5 = e5.body.getReader();
                        let n5;
                        try {
                          for (; !(n5 = await t5.read()).done; )
                            yield r4.decode(n5.value);
                        } finally {
                          t5.cancel();
                        }
                      }
                    ...
                    return { async *[Symbol.asyncIterator]() {
                      ...
                      try {
                        let e5 = true;
                        for await (const r4 of function(e6, r5) {
                          return { async *[Symbol.asyncIterator]() {
                            try {
                              let t5 = "";
                              for await (const n5 of e6)
                                if (t5 += n5, t5.indexOf(r5) > -1) {
                                  const e7 = t5.lastIndexOf(r5), n6 = t5.slice(0, e7).split(r5).filter((e8) => e8.trim().length > 0).map((e8) => e8.slice(e8.indexOf(m) + m.length).trim());
                                  n6.length > 0 && (yield n6), t5 = t5.slice(e7 + r5.length), "--" === t5.trim() && (t5 = "");
                                }
                            } catch (e7) {
                              throw new Error(`Error occured while processing stream payload - ${w(e7)}`);
                            }
                          } };
                        }(o4, n4)) {
                          const t5 = V(r4);
                          s2 = ((_a3 = t5.find((e6) => e6.extensions)) == null ? void 0 : _a3.extensions) ?? s2;
                          const n5 = $(t5);
                          i3 = E([i3, ...t5.map(({ data: e6 }) => e6)]), e5 = t5.slice(-1)[0].hasNext, q(n5, i3), yield { ...S("data", i3), ...S("extensions", s2), hasNext: e5 };
                        }
                        if (e5)
                          throw new Error("Response stream terminated unexpectedly");
                      } catch (r4) {
                        const t5 = b(r4);
                        yield { ...S("data", i3), ...S("extensions", s2), errors: { message: g(w(r4)), networkStatusCode: e4.status, ...S("graphQLErrors", t5 == null ? void 0 : t5.graphQLErrors), response: e4 }, hasNext: false };
                      }
                    } };
                  }(t3, o3);
                default:
                  throw new Error(`${s} ${o3}`, { cause: t3 });
              }
            } catch (e4) {
              return { async *[Symbol.asyncIterator]() {
                const r3 = b(e4);
                yield { errors: { message: g(w(e4)), ...S("networkStatusCode", r3 == null ? void 0 : r3.status), ...S("response", r3) }, hasNext: false };
              } };
            }
          };
        }(x2);
        return { config: f2, fetch: x2, request: k2, requestStream: C2 };
      }
      async function j(e2) {
        const { errors: r2, data: t2, extensions: n2 } = await e2.json();
        return { ...S("data", t2), ...S("extensions", n2), ...r2 || !t2 ? { errors: { networkStatusCode: e2.status, message: g(r2 ? o : i), ...S("graphQLErrors", r2), response: e2 } } : {} };
      }
      function V(e2) {
        return e2.map((e3) => {
          try {
            ...
            throw new Error(`Error in parsing multipart response - ${w(e4)}`);
          }
        }).map((e3) => {
          const { data: r2, incremental: t2, hasNext: n2, extensions: o2, errors: s2 } = e3;
          if (!t2)
            return { data: r2 || {}, ...S("errors", s2), ...S("extensions", o2), hasNext: n2 };
          const i2 = t2.map(({ data: e4, path: r3, errors: t3 }) => ({ data: e4 && r3 ? v(r3, e4) : {}, ...S("errors", t3) }));
          return { data: 1 === i2.length ? i2[0].data : E([...i2.map(({ data: e4 }) => e4)]), ...S("errors", $(i2)), hasNext: n2 };
        });
      }
      function q(e2, r2) {
        if (e2.length > 0)
          throw new Error(o, { cause: { graphQLErrors: e2 } });
        if (0 === Object.keys(r2).length)
          throw new Error(i);
      }
      function C({ client: e2, currentSupportedApiVersions: r2, apiVersion: t2, logger: n2 }) {
        const o2 = `${e2}: the provided apiVersion ("${t2}")`, s2 = `Currently supported API versions: ${r2.join(", ")}`;
        if (!t2 || "string" != typeof t2)
          throw new Error(`${o2} is invalid. ${s2}`);
        const i2 = t2.trim();
        r2.includes(i2) || (n2 ? n2({ type: "Unsupported_Api_Version", content: { apiVersion: t2, supportedApiVersions: r2 } }) : console.warn(`${o2} is likely deprecated or not supported. ${s2}`));
      }
      function I(e2) {
        const r2 = 3 * e2 - 2;
        return 10 === r2 ? r2 : `0${r2}`;
      }
      function P(e2, r2, t2) {
        const n2 = r2 - t2;
        return n2 <= 0 ? `${e2 - 1}-${I(n2 + 4)}` : `${e2}-${I(n2)}`;
      }
      function N() {
        const { year: e2, quarter: r2, version: t2 } = function() {
          const e3 = /* @__PURE__ */ new Date(), r3 = e3.getUTCMonth(), t3 = e3.getUTCFullYear(), n3 = Math.floor(r3 / 3 + 1);
          return { year: t3, quarter: n3, version: `${t3}-${I(n3)}` };
        }(), n2 = 4 === r2 ? `${e2 + 1}-01` : `${e2}-${I(r2 + 1)}`;
        return [P(e2, r2, 3), P(e2, r2, 2), P(e2, r2, 1), t2, n2, "unstable"];
      }
      const O = "application/json", R = "Storefront API Client";
      e.createStorefrontApiClient = function({ storeDomain: e2, apiVersion: r2, publicAccessToken: t2, privateAccessToken: n2, clientName: o2, retries: s2 = 0, customFetchApi: i2, logger: a2 }) {
        const c2 = N(), u2 = function({ client: e3, storeDomain: r3 }) {
          try {
            if (!r3 || "string" != typeof r3)
              throw new Error();
            const e4 = r3.trim(), t3 = e4.match(/^https?:/) ? e4 : `https://${e4}`, n3 = new URL(t3);
            return n3.protocol = "https", n3.origin;
          } catch (t3) {
            throw new Error(`${e3}: a valid store domain ("${r3}") must be provided`);
          }
        }({ client: R, storeDomain: e2 }), l2 = { client: R, currentSupportedApiVersions: c2, logger: a2 };
        C({ ...l2, apiVersion: r2 }), function(e3, r3) {
          if (!e3 && !r3)
            throw new Error(`${R}: a public or private access token must be provided`);
          if (e3 && r3)
            throw new Error(`${R}: only provide either a public or private access token`);
        }(t2, n2), function(e3) {
          if (e3 && "undefined" != typeof window)
            throw new Error(`${R}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`);
        }(n2);
        const p2 = function(e3, r3, t3) {
          return (n3) => {
            n3 && C({ ...t3, apiVersion: n3 });
            const o3 = (n3 ?? r3).trim();
            return `${e3}/api/${o3}/graphql.json`;
          };
        }(u2, r2, l2), d2 = { storeDomain: u2, apiVersion: r2, ...t2 ? { publicAccessToken: t2 } : { privateAccessToken: n2 }, headers: { "Content-Type": O, Accept: O, "X-SDK-Variant": "storefront-api-client", "X-SDK-Version": "0.3.3", ...o2 ? { "X-SDK-Variant-Source": o2 } : {}, ...t2 ? { "X-Shopify-Storefront-Access-Token": t2 } : { "Shopify-Storefront-Private-Token": n2 } }, apiUrl: p2(), clientName: o2 }, f2 = k({ headers: d2.headers, url: d2.apiUrl, retries: s2, customFetchApi: i2, logger: a2 }), h2 = function(e3) {
          return (r3) => ({ ...r3 ?? {}, ...e3.headers });
        }(d2), y2 = function(e3, r3) {
          return (t3) => t3 ? r3(t3) : e3.apiUrl;
        }(d2, p2), m2 = function({ getHeaders: e3, getApiUrl: r3 }) {
          return (t3, n3) => {
            const o3 = [t3];
            if (n3 && Object.keys(n3).length > 0) {
              const { variables: t4, apiVersion: s3, headers: i3, retries: a3 } = n3;
              o3.push({ ...t4 ? { variables: t4 } : {}, ...i3 ? { headers: e3(i3) } : {}, ...s3 ? { url: r3(s3) } : {}, ...a3 ? { retries: a3 } : {} });
            }
            return o3;
          };
        }({ getHeaders: h2, getApiUrl: y2 }), g2 = { config: d2, getHeaders: h2, getApiUrl: y2, fetch: (...e3) => f2.fetch(...m2(...e3)), request: (...e3) => f2.request(...m2(...e3)), requestStream: (...e3) => f2.requestStream(...m2(...e3)) };
        return Object.freeze(g2);
      };
    });
  }
});
...
var require_client3 = __commonJS({
  "node_modules/@shopify/shopify-api/lib/clients/storefront/client.js"(exports) {
    ...
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    var storefront_api_client_1 = require_storefront_api_client_min();
    var logger_1 = require_logger();
    var ShopifyErrors = tslib_1.__importStar(require_error());
    var error_1 = require_error();
    var runtime_1 = require_runtime();
          ...
          switch (key) {
            ...
            case "accountOwner":
              if (returnUserData) {
                return [
                  key,
                  associatedUserObj.associated_user.account_owner = Boolean(value)
                ];
              }
            case "locale":
              if (returnUserData) {
            ...
            case "collaborator":
              if (returnUserData) {
                return [
                  key,
                  associatedUserObj.associated_user.collaborator = Boolean(value)
                ];
              }
            case "emailVerified":
              if (returnUserData) {
                return [
                  key,
                  associatedUserObj.associated_user.email_verified = Boolean(value)
                ];
              }
            default:
              return [key, value];
          ...
          switch (key) {
            ...
            case "onlineAccessInfo":
              if (!returnUserData) {
                ...
                return [
                  ["userId", (_a2 = value === null || value === void 0 ? void 0 : value.associated_user) === null || _a2 === void 0 ? void 0 : _a2.id],
                  ["firstName", (_b2 = value === null || value === void 0 ? void 0 : value.associated_user) === null || _b2 === void 0 ? void 0 : _b2.first_name],
  ...
  "node_modules/@shopify/shopify-api/lib/webhooks/process.js"(exports) {
    ...
    function process(config, webhookRegistry) {
      return function process2(_a2) {
        var { context, rawBody } = _a2, adapterArgs = tslib_1.__rest(_a2, ["context", "rawBody"]);
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
          const response = {
          ...
          if (webhookCheck.valid) {
            const handlerResult = yield callWebhookHandlers(config, webhookRegistry, webhookCheck, rawBody, context);
    ...
    function callWebhookHandlers(config, webhookRegistry, webhookCheck, rawBody, context) {
      return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const log = (0, logger_1.logger)(config);
        ...
        for (const handler of handlers) {
          ...
          try {
            yield handler.callback(webhookCheck.topic, webhookCheck.domain, rawBody, webhookCheck.webhookId, webhookCheck.apiVersion, ...(webhookCheck === null || webhookCheck === void 0 ? void 0 : webhookCheck.subTopic) ? webhookCheck.subTopic : "", context);
          } catch (error) {
            response.statusCode = network_1.StatusCode.InternalServerError;
...
@shopify/storefront-api-client/dist/umd/storefront-api-client.min.js:
...
*/
//# sourceMappingURL=@shopify_shopify-api.js.map
